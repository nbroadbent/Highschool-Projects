...
namespace AlgorithmicTrader
{
            ...
            while (true)
            {
                ...
                if (candleSticks != null)
                {
                    ...
                    if (quantity != 0)
                    {
                        ...
                        else if ((0 <= percentChange && percentChange > 1 && quantity > 0) || (0 >= percentChange && percentChange < -1 && quantity < 0))
                        {
                            i = -10;
                        }
                        /*
                    ...
                    wmaShort = Calculate.WeightedMovingAverage(candleSticks, 1);
    ...
    static class Store
    {
        ...
        static private string debugging = "C:\\Applications\\QuestradeAPI\\CSharp\\AlgoTrader\\Practice Account\\Moving Averages\\Daytrade\\1-min 10, 1\\Debugging\\";
