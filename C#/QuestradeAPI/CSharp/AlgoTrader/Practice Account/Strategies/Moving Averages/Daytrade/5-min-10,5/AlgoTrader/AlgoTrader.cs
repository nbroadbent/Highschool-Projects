...
namespace AlgorithmicTrader
{
        ...
        public string MovingAverages(string symbol, int symbolId)
        {
            ...
            while (true)
            {
                ...
                if (candleSticks != null)
                {
                    ...
                    if (empty == 0)
                    {
                        ...
                        if (quantity != 0)
                        {
                            ...
                            //{
                            double percentChange = ((fillPrice / price) * 100 - 100) * -1;
                            int priceMove = (int)Math.Floor((Math.Abs(percentChange) / 0.9));

                            if ((0 <= percentChange && percentChange < 1 && quantity > 0) || (0 >= percentChange && percentChange > -1 && quantity < 0))
                            {
                                ...
                                {
                                    if (Math.Abs(wmaLong - wmaShort) > 7)
                                    {
                                        i -= 1;
                                    }
                                }
                            }
                            else if ((0 <= percentChange && percentChange > 2 && quantity > 0) || (0 >= percentChange && percentChange < -2 && quantity < 0))
                            {
                                i = -10;
                            }
                            /*
                        ...
                        wmaLong = Math.Round(Calculate.WeightedMovingAverage(candleSticks, 9), 2);
                        wmaShort = Math.Round(Calculate.WeightedMovingAverage(candleSticks, 5), 2);
                        oldWmaLong = Math.Round(Calculate.WeightedMovingAverage(candleSticks, 9, 1), 2);
                        oldWmaShort = Math.Round(Calculate.WeightedMovingAverage(candleSticks, 5, 1), 2);
                        ...
                        if (quantity <= 0)
                        {
                            ...
                            if (wmaShort > wmaLong && oldWmaShort < oldWmaLong)
                            {
                                return "Buy";
                            }
                        }
                ...
                else
                {
                    ...
                    // Here we will close out any positions to prevent on loss.
                }
            }
        }       
    }
    ...
    internal static class Request
    {
        ...
        internal static double[,] candlestickData(string accessToken, string apiServer, int symbolId)
        {
            ...
            int startMin = ((int)Math.Floor(((double)(DateTime.Now.Minute - (20*5)) / 5)) * 5);
    ...
    static class Store
    {
        ...
        static private string debugging = "C:\\Applications\\QuestradeAPI\\CSharp\\AlgoTrader\\Practice Account\\Strategies\\Moving Averages\\Daytrade\\5-min-10,5\\Debugging\\";
        ...
        internal static string Retrieve()
        {
            ...
            xDoc.Load("C:\\Applications\\QuestradeAPI\\CSharp\\AlgoTrader\\Practice Account\\Account 1 data\\data.xml");
            try
            {
